...
export class Profile {
    ...
    private constructor(id: string, name: string, isActive: boolean, ps1: string | null, startupPath: StartupFile | null, aliasesPath: AliasesFile | null) {
        this._id = id;
        this._name = name;
    ...
    static create(name: string): Profile {
        ...
        return new Profile(id, name, false, null, null, null);
    }

    static restore(id: string, name: string, isActive: boolean, ps1: string | null, startupPath: StartupFile | null, aliasesPath: AliasesFile | null): Profile {
        return new Profile(id, name, isActive, ps1, startupPath, aliasesPath);
    }
